        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-muted-foreground leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:sstec@stecco.org" className="text-primary hover:underline">sstec@stecco.org</a>{" "}
          ...
          <section>
            ...
            <div className="mt-3 p-4 rounded-lg bg-card border border-border text-sm">
              ...
              <p>
                Email:{" "}
                <a href="mailto:sstec@stecco.org" className="text-primary hover:underline">
                  sstec@stecco.org
                </a>
              </p>
              <p>
